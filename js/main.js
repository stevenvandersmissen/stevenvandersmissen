...
(function () {
  ...
  /* motion preference lives in js/motion.js (loads first); mirror it here */
  function readReduced() {
    return window.__reduced ? window.__reduced()
      : window.matchMedia('(prefers-reduced-motion: reduce)').matches;
  }
  var reduceMotion = readReduced();
  window.addEventListener('motionchange', function () { reduceMotion = readReduced(); });
